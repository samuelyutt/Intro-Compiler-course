...
class FunctionNode : public ASTNodeBase {
  public:
    ...
    vector<NodeWithTypeList *>
        *parameters; // a list of declaration nodes (zero or more)
  ...
  public:
    FunctionNode(int _line_number, int _col_number, string _function_name,
                 vector<NodeWithTypeList *> *_parameters,
                 VariableInfo *_return_type, Node _body, int _end_line_number,
