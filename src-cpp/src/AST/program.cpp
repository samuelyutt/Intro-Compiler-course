...
ProgramNode::ProgramNode(int _line_number, int _col_number,
                         string _program_name, string _return_type,
                         NodeList *_declaration_node_list,
                         NodeList *_function_node_list,
                         Node _compound_statement_node, int _end_line_number,
                         int _end_col_number, string _end_name) {
...
void ProgramNode::print() {
    std::cout << "program <line: " << line_number << ", col: " << col_number
              << "> " << program_name << " void" << std::endl;
}