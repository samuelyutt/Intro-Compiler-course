...
ConstantValueNode::ConstantValueNode(int _line_number, int _col_number,
...
ConstantValueNode::~ConstantValueNode() { SAFE_DELETE(this->constant_value) }

void ConstantValueNode::print() {
    std::cout << "constant <line: " << line_number << ", col: " << col_number
              << "> ";
